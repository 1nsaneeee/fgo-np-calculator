export const PRESETS = {
  ...
  '双杀狐+黑杯': { ce: { npStrength: 80 }, ceAtk: 2400, support: { busterUp: 100, critDmg: 100, atkUp: 40, npRate: 50 } },
  '双RBA+绿': { ce: { npStrength: 60 }, support: { quickUp: 100, critDmg: 100, atkUp: 40, npRate: 30 } },
